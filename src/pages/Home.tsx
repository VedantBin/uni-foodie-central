...
const Home = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-university-primary text-white py-16">
        <div className="container mx-auto px-4 flex flex-col items-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Button 
              asChild
              className="bg-university-secondary hover:bg-university-secondary/90 text-white"
              size="lg"
            >
            ...
            <Button 
              asChild
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-university-primary"
              size="lg"
            >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Featured Campus Spots</h2>
          ...
          <div className="text-center mt-10">
            <Button asChild variant="outline" className="border-university-primary text-university-primary hover:bg-university-primary hover:text-white">
      ...
      <section className="py-16 bg-university-secondary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button asChild size="lg" className="bg-white text-university-secondary hover:bg-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/cafes" className="text-gray-300 hover:text-white">Campus Food Spots</Link></li>
